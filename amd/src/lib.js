...
const clearHistory = (blockId) => {
    ...
    document.querySelector('#openai_chat_log').innerHTML = '<div class="openai_message bot onboarding_message"><p>Halo! Aku asisten akademik untuk mata kuliah ini. Aku siap membantu menjawab pertanyaan seputar materi perkuliahan. Silakan mulai bertanya! 😊</p></div>';
}

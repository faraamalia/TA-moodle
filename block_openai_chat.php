...
class block_openai_chat extends block_base {
    ...
    public function get_content() {
        ...
        $pesan_onboarding = 'Halo! Aku asisten akademik mata kuliah ini. Silakan ajukan pertanyaan seputar materi perkuliahan! 😊';
        ...
        $this->content->text = '
            ...
            <div id="openai_chat_log" role="log">
            <div class="openai_message bot onboarding_message">
                <p> ' . $pesan_onboarding . ' </p>            
            </div>
            </div>
        ';
        ...
        if (
            ...
            $contextdata = [
                ...
                'pix_popout' => '/blocks/openai_chat/pix/arrow-up-right-from-square1.svg',
                'pix_close' => '/blocks/openai_chat/pix/close-window.svg',
                'pix_send' => '/blocks/openai_chat/pix/send1.svg',
                'pix_refresh' => '/blocks/openai_chat/pix/refresh.svg',
                'msg_onboarding' => $pesan_onboarding
            ];

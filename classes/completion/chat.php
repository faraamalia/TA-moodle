...
class chat extends \block_openai_chat\completion
{
    ...
    {   
        ...
        $coursename = $course ? $course->fullname : 'mata kuliah ini';

        // Modify the prompt based on the course
        switch ($courseid) {
            case 2:
                $topic = $coursename;
                break;
        ...
        // Original logic to append source of truth and format history
        ...
        // Make the API call with the modified prompt
